...
def get_code(file_name):
    ...
    try:
        ...
        github_token = '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'
        ...
        print(f"Matched path: {file_path}")
        ...
        print(f"Retrieved code content:\n{decoded_content}")
    ...
    return {
        'statusCode': 200,
        'body': json.dumps({'code': decoded_content})
    }

...
# }
#
# # Add an inline policy to the codepipeline_role
...
# }
#
# # inline policy for the codepipeline-role that specifically allows it to start builds for project
...
# }
#
# resource "aws_iam_role_policy" "codepipeline_codebuild_get_policy" {
#   name = "codepipeline-codebuild-get-policy"
#   role = aws_iam_role.codepipeline_role.id
#
#   policy = <<EOF
# {

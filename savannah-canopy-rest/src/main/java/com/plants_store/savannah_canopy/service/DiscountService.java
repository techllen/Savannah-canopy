...
public interface DiscountService {
     ...
     * @param plantId The ID of the plant. Should not be null.
    ...
    // Added check for null plantId
    default double calculateDiscount(Long plantId, int percentage) {
        if (plantId == null) {
            throw new ErrorContext("Plant ID cannot be null.");
        }
        return calculateDiscount(plantId, percentage);
    }
}